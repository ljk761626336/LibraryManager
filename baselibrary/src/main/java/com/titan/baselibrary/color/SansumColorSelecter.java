package com.titan.baselibrary.color;
...
public class SansumColorSelecter extends RelativeLayout implements OnTouchListener {
	...
	private int[] mColorIcon = { R.id.color_1, R.id.color_2, R.id.color_3,
			...
			R.id.color_8, R.id.color_9, R.id.color_10, R.id.color_11,
			R.id.color_12, R.id.color_13, R.id.color_14, R.id.color_15,
			R.id.color_16 };

	private int[] mColorValue = { R.color.color_1, R.color.color_2,
			R.color.color_3, R.color.color_4, R.color.color_5, R.color.color_6,
			R.color.color_7, R.color.color_8, R.color.color_9,
			R.color.color_10, R.color.color_11, R.color.color_12,
			R.color.color_13, R.color.color_14, R.color.color_15,
			R.color.color_16 };
	...
	public SansumColorSelecter(Context context, AttributeSet attrs) {
		...
		inflater.inflate(R.layout.color_selecter, this, true);
...
//	}
	...
	public void changeLastColor(int diyColor) {
		if (!mIsDIYColor) {
			mColorValue[mColorValue.length - 1] = getResources().getColor(
					R.color.color_16);
